...
phraseMissMachinOne = "Mademoiselle Machin épouse un homme qui est"
phraseMissMachinTwo = "sec comme un coucou"
...
textHusbandDies = ^ \markup \italic "La mari se meurt d'epuisement"
...
highVoice = \relative c'' {
  ...
  b4 ) \octaveOff s8 \moveTextLeftA s4. _ \markup \large "Arrêt" |
  s2. * 5 |
